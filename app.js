while (!player1){
    var player1 = prompt('Speler een: Vul je naam in. Jij bent rood.');
};
var player1Color = 'red';

while (!player2){
    var player2 = prompt('Speler twee: Vul je naam in. Jij bent geel.');
};
        ...
        if (tableRow[i].children[column].style.backgroundColor == 'white'){
            ...
            if (currentPlayer === 1){
                ...
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    playerTurn.textContent = `${player1} gewonnen!!`;
                    playerTurn.style.color = player1Color;
                    return alert(`${player1} gewonnen!!`);
                }else if (drawCheck()){
                ...
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    playerTurn.textContent = `${player2} gewonnen!!`;
                    playerTurn.style.color = player2Color;
                    return alert(`${player2} gewonnen!!`);
                }else if (drawCheck()){
                    playerTurn.textContent = 'gelijk spel!';
                    return alert('gelijk spel!');
                }else{
